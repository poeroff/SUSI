...
const paintMovieInfo = (movieInfo) => {
  ...
  if (movieInfo[0] !== undefined) {
    ...
    image.setAttribute(
      "src",
      `https://previews.123rf.com/images/lkeskinen/lkeskinen1707/lkeskinen170701286/81349530-no-information-rubber-stamp.jpg`
    );
